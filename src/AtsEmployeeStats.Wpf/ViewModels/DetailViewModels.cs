...
internal static class Rows
{
    ...
    public static GridRowViewModel City(CompanyDto company, CityDto city) =>
        new(city.DisplayName, RowFormatting.Money(city.BidirectionalProfit, company.CurrencySymbol), city.HasOwnedGarage ? "Owned garage" : "No owned garage", $"Expansion {city.ExpansionScore:0.##} / Origin {city.PlayerOriginScore:0.##}", [], city)
        {
